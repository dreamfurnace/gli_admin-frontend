...
const filteredPhases = computed(() => {
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter(phase => phase.title_ko.toLowerCase().includes(query) ||
...
const toggleActive = async (phase) => {
    try {
...
if (__VLS_ctx.loading) {
    ...
    for (const [phase] of __VLS_getVForSourceType((__VLS_ctx.filteredPhases))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
            key: (phase.id),
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!!(__VLS_ctx.loading))
                        return;
                    if (!(__VLS_ctx.filteredPhases.length > 0))
                        return;
                    __VLS_ctx.editPhase(phase);
                } },
    ...
    (__VLS_ctx.searchQuery ? '검색 결과가 없습니다' : '첫 번째 전략 로드맵 페이즈를 추가하세요');
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.openCreateModal) },
...
if (__VLS_ctx.showModal) {
    ...
    (__VLS_ctx.isEditing ? '전략 로드맵 페이즈 수정' : '전략 로드맵 페이즈 추가');
    __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
        ...{ onSubmit: (__VLS_ctx.savePhase) },
        ...{ class: "p-6 space-y-4" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
...
if (__VLS_ctx.showDeleteModal) {
    ...
    (__VLS_ctx.phaseToDelete?.title_ko);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
//# sourceMappingURL=StrategyRoadmapView.vue.js.map