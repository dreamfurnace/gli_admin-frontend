...
const filteredFeatures = computed(() => {
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter(feature => feature.title_ko.toLowerCase().includes(query) ||
...
if (__VLS_ctx.loading) {
...
else if (__VLS_ctx.filteredFeatures.length > 0) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    for (const [feature] of __VLS_getVForSourceType((__VLS_ctx.filteredFeatures))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
            key: (feature.id),
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!!(__VLS_ctx.loading))
                        return;
                    if (!(__VLS_ctx.filteredFeatures.length > 0))
                        return;
                    __VLS_ctx.editFeature(feature);
                } },
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.filteredFeatures.length > 0))
                        return;
                    __VLS_ctx.toggleActive(feature);
                } },
            ...{ class: (feature.is_active
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.filteredFeatures.length > 0))
                        return;
                    __VLS_ctx.deleteFeature(feature);
                } },
    ...
    (__VLS_ctx.searchQuery ? '검색 결과가 없습니다' : '첫 번째 프로젝트 특징을 추가하세요');
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.openCreateModal) },
...
if (__VLS_ctx.showModal) {
    ...
    (__VLS_ctx.isEditing ? '프로젝트 특징 수정' : '프로젝트 특징 추가');
    __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)({
        ...{ onSubmit: (__VLS_ctx.saveFeature) },
        ...{ class: "p-6 space-y-4" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
...
if (__VLS_ctx.showDeleteModal) {
    ...
    (__VLS_ctx.featureToDelete?.title_ko);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
//# sourceMappingURL=ProjectIntroView.vue.js.map